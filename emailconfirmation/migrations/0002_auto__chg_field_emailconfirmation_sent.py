...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailConfirmation.sent'
        db.alter_column('emailconfirmation_emailconfirmation', 'sent', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'EmailConfirmation.sent'
        db.alter_column('emailconfirmation_emailconfirmation', 'sent', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
